...
cp dashboard/public/data/nacka-current.json dashboard/build/data/nacka-current.json
...
cp dashboard/public/data/nacka-hourly.json dashboard/build/data/nacka-hourly.json

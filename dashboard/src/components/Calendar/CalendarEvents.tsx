...
const groupedEvents: DayEvents[] = Object.values(groupedEventsMap).sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime());

const CalendarEvents: React.FC = () => (
  <div className="calendar-events">
    {groupedEvents.map((day, dayIdx) => (
      <div key={dayIdx} className="calendar-events__day">
        <h2 className="calendar-events__title">{day.weekday}, {day.date}</h2>
